...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table>
        ...
        <tr>
            ...
            <td >                                
                <asp:Button  ID="btnVerificarIntegridad" runat="server" Text="Ejecutar" OnClick="btnVerificarIntegridad_Click" />                                
            </td>
        </tr>                        
        <tr> <td></td> </tr>
        <tr>
            ...
            <td >                                
                <asp:Button  ID="btnRecalcularDigitosVerificadores" runat="server" Text="Ejecutar" OnClick="btnRecalcularDigitosVerificadores_Click" />                                
            </td>
        </tr>
        <tr> <td></td> </tr>
        <tr>
            ...
            <td >                                
                <asp:Button  ID="btnRestaurar" runat="server" Text="Acceder" OnClick="btnRestaurar_Click" />                                
            </td>
        </tr>
        <tr>
            <td>
